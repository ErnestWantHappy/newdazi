...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '县考主表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of biz_county_exam
-- ----------------------------
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '县考答题明细' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of biz_county_exam_answer
-- ----------------------------
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '县考班级指派表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of biz_county_exam_class
-- ----------------------------
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '评卷任务分配' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of biz_county_exam_grader
-- ----------------------------
...
CREATE TABLE `biz_county_exam_question`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_exam_id`(`exam_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '县考题目表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of biz_county_exam_question
-- ----------------------------
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '县考学生成绩总表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of biz_county_exam_student
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 760 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统访问记录' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_logininfor` VALUES (759, '19157727791', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-19 09:36:15');
...
INSERT INTO `sys_user` VALUES (104, 107, '19157727791', '郑东旭', '00', '', '', '0', '', '$2a$10$PWHYbxojQaQh4Pi5ugZyjeXMMszlf621A5KRFASQIIc8.iwYmuAR6', '0', '0', '127.0.0.1', '2026-01-19 09:36:15', '2025-07-02 10:14:56', 'admin', '2025-06-25 10:28:28', 'admin', '2026-01-19 09:36:14', NULL);
