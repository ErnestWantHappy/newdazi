...
- 活动通知免登录分享：令牌生成、复制、撤销、匿名正文和受控图片读取。
...
- [x] 5. 公开通知分享
  - [x] 5.1 后端令牌生成、哈希存储、有效期、撤销与匿名 DTO
  - [x] 5.2 正文图片令牌校验和路径越权防护
  - [x] 5.3 Vue3 分享弹窗、免登录路由和匿名通知页
  - [ ] 5.4 执行数据库增量 SQL、接口权限测试和浏览器匿名冒烟
