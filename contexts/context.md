...
> **当前焦点（2026-08-09：操作题 AI 批改 v4 已发布 10.52.1.123；全班重新生成仍只产出建议，教师可在批量采用时选择“仅补未评分”或经二次确认“覆盖已有评分”，每份覆盖保留前后审计；真实学生准确率与隐私门禁仍未据此解除）**
...
| 当前开发分支 | `codex/research-activity-v1`（当前统一提交 `0a6a6e4` 已 push，草稿 PR #3 已包含；用户要求不再新建分支） |
...
| 前端 3010 | **当前统一 release** `20260809_152820_0a6a6e4`；后端 3009 同版，旧后端 `20260809_131500_a8b80ac`、旧前端 `20260809_133739_997f57b` 与更早版本均保留；80 端口站点未改动 |
