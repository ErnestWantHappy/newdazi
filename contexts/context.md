...
| 模块         | 功能点     | 详细描述                                                                                   | 关键交互/接口                            |
| :----------- | :--------- | :----------------------------------------------------------------------------------------- | :--------------------------------------- |
| **课程设计** | 课程管理   | 创建/编辑/删除课程，支持拖拽排序题目，设定课程总分与及格线。                               | `designer.vue`, `BizLessonController`    |
...
| **学情分析** | 数据看板   | **ECharts 可视化**：班级均分对比、不及格名单、进退步分析、打字速度分布。                   | `score/index.vue`, `TeacherDashboard`    |
