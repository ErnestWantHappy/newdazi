...
> **当前焦点（2026-08-09：操作题 AI 批改 v3 与教师批改页窄屏布局热修已发布 10.52.1.123；处理详情、逐份阶段/失败原因、心跳/ETA、参考材料单次准备、服务重启接续和 125% 缩放三栏稳定性已完成，真实学生准确率与隐私门禁仍未据此解除）**
...
> 12. **GitHub 与正式发布事实**：代码已提交并推送 `codex/research-activity-v1`，现有草稿 PR #3 已包含操作题 AI v3 提交 `a8b80ac`、批改页布局热修 `997f57b` 及此前发布/恢复提交。当前正式 release、备份、制品哈希和验收事实以第 17～20 条为准；`20260809_121339_0d93535` 保留为完整应用回滚点。
...
| 当前开发分支 | `codex/research-activity-v1`（当前前端提交 `997f57b`、后端提交 `a8b80ac` 均已 push，草稿 PR #3 已包含；用户要求不再新建分支） |
...
| 前端 3010 | **当前前端 release** `20260809_133739_997f57b`；直接回滚点 `20260809_131500_a8b80ac` 与更早版本均保留；80 端口站点未改动 |
