...
> **当前焦点（2026-08-07：操作题多格式作品与 AI 草稿批改已发布 10.52.1.123；匿名合成学生的 PPT/Excel/图片提交、预览、权限与 AI 批量链路已验收，真实学生作品仍受隐私与盲测门禁约束）**
...
> 12. **GitHub 与正式发布事实**：代码已提交并推送 `codex/research-activity-v1`，现有草稿 PR #3 已包含发布提交 `9328868` 及恢复热修 `b8146ab`、`2de7a1e`、`0724ace`、`011941d`、`4dcb696`。当前 release 为 `20260807_165505_4dcb696`，上一版 `20260807_164904_011941d` 和原始发布版 `20260807_152632_9328868` 均保留。最终发布前备份为 `D:\program\3009dazipingtai\backups\20260807_165527_4dcb696_short_profile`，SQL 75,200,439 bytes，SHA-256 `C9E765F73BC6B9CD0072303B64A75712E20D496441D2508E8209A0011AF74581`；测试数据清理前备份为 `20260807_170516_student_e2e_cleanup_4dcb696`，SQL 75,214,600 bytes，SHA-256 `19997F203029D226266937F887239E2F774FF4B1702DD0A4BA693A89154DAEC8`。最终 JAR SHA-256 为 `629E721EDF2F6AB2B948E2709AB2215270DC56CD8B1E8491B18F4BEBE75D81D9`；3009/3010 均为 200，最后一次启动后 ERROR=0、stderr=0、临时转换目录=0。
...
| 当前开发分支 | `codex/research-activity-v1`（当前服务器代码提交 `4dcb696` 已 push，草稿 PR #3 已包含；用户要求不再新建分支） |
...
| 前端 3010 | **当前 release** `20260807_165505_4dcb696`（前端内容沿用 `9328868`）；上一版 `20260807_164904_011941d` 与原始发布回滚点均保留；80 端口站点未改动 |
