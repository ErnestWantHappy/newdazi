...
> **当前焦点（2026-08-02：课程监管与免抽测交互收口已在本机完成，待正式服务器发布）**
> 0. **本轮产品结论**：课程与成绩监管、免抽测申请审核改为两个左侧独立菜单；课程监管默认“按时间查看”，以“课程 + 班级”为行按首次真实使用日期倒序，保留“按学校查看”的学校→教师→课程下钻。监管批改筛选只显示“待批改 / 已批改 / 已逾期”。
